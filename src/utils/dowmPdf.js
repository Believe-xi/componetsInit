 ...
 * */
 ...
 function addWaterMarker(str, parentDom) {
    let mainBox = document.getElementById(`download-box`);
    ...
    if(cans.measureText(cpyName).width > widths) {
      var size = widths / cpyName.length
...
export function downloadPDF(ele, pdfName, callback) {
